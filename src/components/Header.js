...
function Header() {
  ...
  return (
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-6 bg-black">
      {loading && <Loader/>}
      ...
      <div className='flex h-5 items-center'> 
          ...
          <Link to="/" className='flex h-5 items-center'> 
            <img className='h-full hidden md:block' src={ytLogo} alt='uTube'/>
            <img className='h-full md:hidden' src={ytLogoMobile} alt='uTube'/>
          </Link>
            </div>
          ...
          <button className='w-[40px] md:w-[60px] h-8 md:h-10 flex items-center justify-center border-l-0 border-[#303030] rounded-r-3xl bg-white/[0.1]'>
              ...
              <div className='flex items-center'>
                ...
                <div className='flex h-8 overflow-hidden rounded-full md:ml-4'>
                      <img src='https://xsgames.co/randomusers/assets/avatars/male/26.jpg'/>
                </div>
                </div>
              </div>
          </div>
